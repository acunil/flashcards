...
class CsvExportServiceTest {
  ...
  void exportCards_fromDeck_createsCsvWithCards() throws IOException {
    ...
    // Mock cardRepository to return some cards if needed
    ...
    assertThat(csvContent).contains("Front 1", "Back 1", "Hint Front 1", "Hint Back 1", "Deck 1");
    assertThat(csvContent)
        .contains("Front 2", "Back 2", "", "", "Deck 1;Deck 2"); // No hints for card2
  }
