...
class DeckServiceTest {
  ...
  void testGetDeckById_throwsExceptionIfDeckNotFound() {
    ...
    assertThatThrownBy(() -> deckService.getDeckById(99L))
  ...
  void testGetDeckByName_throwsExceptionIfDeckNotFound() {
    ...
    assertThatThrownBy(() -> deckService.getDeckByName("Nonexistent Deck"))
        .isInstanceOf(DeckNotFoundException.class)
  ...
  void testGetDeckSummariesBySubjectId() {
    ...
    assertThat(deckSummaries).hasSize(2).extracting("name").containsExactly("Deck 1", "Deck 2");
  }
  ...
  void testRenameDeck_throwsExceptionIfNameNotUnique() {
    ...
    assertThatThrownBy(() -> deckService.renameDeck(1L, newName))
        .isInstanceOf(DuplicateDeckNameException.class)
        .hasMessageContaining(
            "A deck with the name '" + newName + "' already exists in subject Subject 1");
  }
}
